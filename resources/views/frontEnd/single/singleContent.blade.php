			...
			<div class="single-page">
				<div class="single-page-row" id="detail-21">
					...
					<div class="col-md-6 single-top-right">
						<h3 class="item_name">{{ $singleProduct->product_name }}</h3>
						<p>{!! $singleProduct->product_short_description !!}</p>
						<div class="single-price">
							<ul>
								<li>BDT {{ $singleProduct->product_price }}</li>  
							</ul>	
						</div> 
						<p class="single-price-text">{!! $singleProduct->product_long_description !!}</p>
				...
				<div class="panel-group collpse" id="accordion" role="tablist" aria-multiselectable="true">
					...
					<div class="panel panel-default">
						...
						<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
							<div class="panel-body">
								{!! $singleProduct->product_long_description !!}
							</div>
						</div>
					</div>
				</div>
