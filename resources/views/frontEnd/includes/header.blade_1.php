		...
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				<ul>
					...
					<li class="dropdown head-dpdn">
						<a href="{{ url("contact") }}" class="dropdown-toggle"><i class="fa fa-map-marker" aria-hidden="true"></i> Store Finder</a>
					</li> 
					<li class="dropdown head-dpdn">
			...
			<div class="container">
				...
				<div class="header-cart"> 
					<div class="my-account">
						<a href="{{ url("contact") }}"><i class="fa fa-map-marker" aria-hidden="true"></i> CONTACT US</a>						
					</div>
					<div class="cart"> 
