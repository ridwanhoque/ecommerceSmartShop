				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="{{ asset("public/frontEnd/images/e1.png") }}" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="{{ url("single") }}">Audio speaker</a></h5> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.html"><img src="{{ asset("public/frontEnd/images/e2.png") }}" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.html"><img src="{{ asset("public/frontEnd/images/e3.png") }}" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="single.html"><img src="{{ asset("public/frontEnd/images/e4.png") }}" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
