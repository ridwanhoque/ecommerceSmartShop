		...
		<div class="container">
			<div class="col-md-9 product-w3ls-right">
				...
				<div class="products-row">
                                        @foreach($activeProductsByCategory as $activeProductByCategory)
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							<div class="new-tag"><h6>20%<br>Off</h6></div>
							<a href="single.html"><img src="{{ asset($activeProductByCategory->product_image) }}" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="{{ url("single") }}">{{ $activeProductByCategory->product_name }}</a></h5> 
								<h6>BDT {{ $activeProductByCategory->product_price }}</h6> 
